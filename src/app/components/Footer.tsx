// Server Component — "use client" removed. LazyMap handles its own client logic.
import Image from "next/image";
import LazyMap from "./LazyMap";

export default function Footer() {
  return (
    <footer className="relative bg-transparent text-white pt-24 pb-10 overflow-hidden cv-section">
      ...
      <div className="relative max-w-[1200px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          <div className="flex items-center gap-4 mb-6">
            <div className="w-16 h-16 rounded-full overflow-hidden border border-white/20 flex items-center justify-center">
              <Image
                src="/cosmodocs_logo.webp"
                alt="Cosmodocs Logo"
                width={56}
                height={56}
        ...
        <div>
          ...
          <ul className="space-y-3 text-white/70 text-sm">
            ...
            <li><a href="#contact" className="hover:text-lemon-green">Contact Us</a></li>
        ...
        {/* LOCATION (MAP) — lazy loaded via client island */}
        <div>
        ...
        <div>
          ...
          <div className="space-y-4 text-sm text-white/70">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-start gap-3 hover:text-lemon-green hover:translate-x-1 transition-all"
            >
              <span>📍</span>
              <span>Unit 111, Tulip Chowk, Spaze Corporate Parkk, Sector 69, Gurugram, Haryana 122101, India</span>
            </a>
          </div>
          ...
          <div className="flex gap-4 mt-6">
            <a
              href="https://www.instagram.com/cosmodocs?igsh=MXN5MDI1cm1raWUwag%3D%3D&utm_source=qr"
              aria-label="Instagram"
              className="w-10 h-10 rounded-[12px] bg-white/10 flex items-center justify-center hover:bg-lemon-green hover:text-medical-blue hover:-translate-y-1 transition-all shadow-lg"
            >
